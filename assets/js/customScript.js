    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if(response.data.logo){
                $("#e_logo").attr("src",SITE_URL+'assets/uploads/'+response.data.logo);
            }else{
                $("#e_logo").attr("src",SITE_URL+'assets/img/person.png');
            }
            if(response.data.image){
                $("#e_image").attr("src",SITE_URL+'assets/uploads/'+response.data.image);
            }else{
                $("#e_image").attr("src",SITE_URL+'assets/img/bg-abstract2.png');
            }
            ...
            $('#e_desc').text(response.data.description);
