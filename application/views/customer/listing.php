...
<section class="d-flex align-items-center hero-bg">
    ...
    <div class="container">
        <div class="text-center">
            <h1 data-aos="fade-up">My Listings</h1>
    ...
    <section id="features" class="features">
        <div class="container">
            ...
            <div class="text-center mb-3">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addEstab">
                    <i class="bi bi-plus"></i> Establishment
                </button>
            </div>
            <div class="card card-profile">
                <div class="card-header">
                    <h6 class="card-title mt-2">My Listings</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($estab as $row) : ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars(date('F d, Y h:i:s A', strtotime($row['date'])), ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td>
                                            <div class="form-button-action">
                                                <a class="btn btn-link" type="button" onclick="editEstab(this)" href="#editEstab" data-toggle="modal" title="Edit Category" data-id="<?= $row['id'] ?>">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <a class="btn btn-link text-danger" type="button" href="<?= site_url("establishment/delete/" . $row['id']); ?>" data-toggle="tooltip" onclick="return confirm('Are you sure you want to delete this establishment?');" data-original-title="Remove">
