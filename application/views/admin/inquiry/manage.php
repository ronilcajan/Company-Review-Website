                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a class="btn btn-link btn-danger p-1" type="button" href="<?= site_url("inquiry/delete/" . $row['id']); ?>" data-toggle="tooltip" onclick="return confirm('Are you sure you want to delete this inquiry?');" data-original-title="Remove">
