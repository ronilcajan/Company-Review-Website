        ...
        <div class="card card-with-nav">
            ...
            <div class="card-body">
                <form method="POST" action="<?= site_url(uri_string()) ?>" enctype="multipart/form-data" id="update_user_form">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="input-file input-file-image text-center mb-3">
                                <?php if (empty($user->avatar)) : ?>
                                    <img class="img-upload-preview img-circle ml-auto mr-auto" width="180" height="180" src="<?= site_url() ?>assets/img/person.png" alt="preview">
                                <?php else : ?>
                                    <img class="img-upload-preview img-circle ml-auto mr-auto" width="180" height="180" src="<?= site_url() . 'assets/uploads/' . $user->avatar ?>" alt="preview">
                                <?php endif ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-group-default">
                                ...
                                <input type="date" class="form-control" name="birthdate" value="<?= $user->birthdate == '' ? null : date('Y-m-d', strtotime($user->birthdate)) ?>">
                            </div>
                            <div class="form-group form-group-default">
                                <label>Gender</label>
            ...
            <div class="card-header" style="background-image: url('<?= site_url() ?>/assets/img/blogpost.jpg')">
                <div class="profile-picture">
                    <div class="avatar avatar-xl">
                        ...
                        <?php else : ?>
                            <img class="avatar-img rounded-circle" alt="preview" src="<?= preg_match('/data:image/i', $user->avatar) ? $user->avatar : site_url() . 'assets/uploads/' . $user->avatar ?>" />
                        <?php endif ?>
                    </div>
                </div>
            </div>
