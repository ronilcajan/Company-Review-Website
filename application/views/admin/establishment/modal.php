<!-- Modal -->
<div class="modal fade" id="addEstab" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-file input-file-image text-center">
                                <img class="img-upload-preview img-circle ml-auto mr-auto" width="120" height="120" src="http://placehold.it/100x100" alt="preview">
                        ...
                        <div class="col-md-6">
                            <div class="input-file input-file-image text-center">
                                <img class="img-upload-preview ml-auto mr-auto" width="180" height="120" src="<?= site_url() ?>assets/img/bgheading01.jpg" alt="preview">
...
<!-- Modal -->
<div class="modal fade" id="editEstab" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Establishment</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
